...
- Не сохраняй текст exception: для состояния `FAILED` используй только `WorkError`.
- Не держи транзакцию PostgreSQL во время сетевого вызова. Используй message work lease.
