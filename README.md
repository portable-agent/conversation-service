...
HTTP endpoint, Agent Runtime и Action Service ещё не подключены. Текущий код надёжно хранит вход,
состояние обработки и ответ; бизнесовый сценарий пока не объявлен готовым.
